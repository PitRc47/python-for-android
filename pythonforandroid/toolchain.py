...
class ToolchainCL:
    ...
    def _build_package(self, args, package_type):
        ...
        with current_directory(dist.dist_dir):
            ...
            env['GRADLE_OPTS'] = "-Xmx12g -XX:MaxMetaspaceSize=4096m -XX:+HeapDumpOnOutOfMemoryError -Dfile.encoding=UTF-8 --parallel"
            os.environ['GRADLE_OPTS'] = "-Xmx12g -XX:MaxMetaspaceSize=4096m -XX:+HeapDumpOnOutOfMemoryError -Dfile.encoding=UTF-8 --parallel"
            ...
            env['GRADLE_OPTS'] = "-Xmx12g -XX:MaxMetaspaceSize=4096m -XX:+HeapDumpOnOutOfMemoryError -Dfile.encoding=UTF-8"
            os.environ['GRADLE_OPTS'] = "-Xmx12g -XX:MaxMetaspaceSize=4096m -XX:+HeapDumpOnOutOfMemoryError -Dfile.encoding=UTF-8"
