...
class ToolchainCL:
    ...
    def _build_package(self, args, package_type):
        ...
        with current_directory(dist.dist_dir):
            ...
            env['GRADLE_OPTS'] = "-Xmx6g -XX:MaxMetaspaceSize=6g --parallel"
            os.environ['GRADLE_OPTS'] = "-Xmx6g -XX:MaxMetaspaceSize=6g --parallel"
            ...
            env['GRADLE_OPTS'] = "-Xmx6g -XX:MaxMetaspaceSize=6g"
            os.environ['GRADLE_OPTS'] = "-Xmx6g -XX:MaxMetaspaceSize=6g"
