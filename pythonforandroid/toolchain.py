...
class ToolchainCL:
    ...
    def _build_package(self, args, package_type):
        ...
        with current_directory(dist.dist_dir):
            ...
            env['GRADLE_OPTS'] = "-Xmx16g -XX:MaxMetaspaceSize=16g --parallel"
            os.environ['GRADLE_OPTS'] = "-Xmx16g -XX:MaxMetaspaceSize=16g --parallel"
            ...
            os.environ['GRADLE_OPTS'] = "-Xmx16g -XX:MaxMetaspaceSize=16g"
